...
Game.Launch=function()
{
	...
	'<div class="listing">&bull; Putting things together, Technical Management -Superbox.</div>'+
	'<div class="listing">&bull; Art (mainly borders and the big coin) and Original Idea -Sandro.</div>'+
	'<div class="listing">&bull; Javascript -Velineste.</div>'+
	'<div class="listing">&bull; Art and most Icons (and these Log Entries too) -Xodabeef.</div>'+
	'<div class="listing">&bull; Some icons -Zekava.</div>'+
	...
	'<div class="listing">&bull; Xoda also got hersdelf unbanned from Neurocord :NeuroHypers:</div>'+
	...
	Game.Init=function()
	{
		...
		new Game.Upgrade('Classic dairy selection','Unlocks the <b>milk selector</b>, letting you pick which milk is displayed under your Neuro.<br>Comes with a variety of basic flavors.<q>Don\'t have a cow, man.</q>',9,[1,8]);Game.last.pool='prestige';Game.last.parents=[];
		...
		Game.last.choicesFunction=function()
		{
			...
			choices[27]={name:'Valentines milk',icon:[26,23,'img/modIcons.png']};
		...
		Game.MilksByChoice={
			...
			27:{pic:'milkGoat'},		//Custom, actually Valentines Milk (name is just from testing)
		};
		...
		*/
		...
		Game.Milks=[
			...
			{name:'Valentines milk',pic:'milkGoat',icon:[26,23,'img/modIcons.png']},
		];
	...
	if (!Game.ready)
	{
		...
		else
		{
			console.log('[=== '+choose([
				'Oh, hello!',
				'hey, how\'s it hangin',
				'About to cheat in some Neuros or just checking for bugs?',
				'Remember : cheated Neuros taste awful!',
				'Hey, Orteil here. Cheated Neuros taste awful... or do they?',
			])+' ===]');
			Game.Load();
			//try {Game.Load();}
			//catch(err) {console.log('ERROR : '+err.message);}
