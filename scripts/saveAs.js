...
function generateSaveAs(view) {
    ...
    let get_URL = function () {
        ...
        }, force_saveable_type = "application/octet-stream", fs_min_size = 0, arbitrary_revoke_timeout = 500,
        revoke = function (file) {
            ...
            let filesaver = this, type = blob.type, blob_changed = false, object_url, target_view,
