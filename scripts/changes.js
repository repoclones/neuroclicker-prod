export const VERSION_STRING = "Neuro Clicker v8.1"
export const UPDATE_LOG =
    ...
    '<div class="listing warning">Warning : clearing your browser cache or cookies will result in your save being wiped. Export your save and back it up first!</div>' +
    ...
    '<div class="title">01.03.2025  - Neuro Clicker: v8.1</div>' +
    '<div class="listing">&bull; Hotfixed the Hotfix (Mistakes in this section).</div>' +
    '<div class="listing">&bull; Scheme unified to "Neuro Clicker v?.? [H for Hotfix]"</div>' +
    '<div class="listing">&bull; Internal changes to make changelogging faster.</div>' +
    '<div class="listing">&bull; Killed 3 Orteil changelogs that were still in here.</div>' +
    '<div class="listing">&bull; Finally removed the Orteil Propaganda. Except for the credits, those are kinda needed so we\'re not completely illegal.</div>' +
    '<div class="listing">&bull; Also forgot to ever mention Xoda being unbanned from NSH, months ago. (Yes, referring to myself in 3rd. As always.)</div>' +

    '</div><div class="subsection update">' +
    '<div class="title">01.03.2025  - Neuro Clicker: v8H</div>' +
