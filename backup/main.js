...
Game.Launch=function()
{
	...
	'<div class="listing">&bull; Some art (mainly borders and the big coin) and original idea -Sandro.</div>'+
	'<div class="listing">&bull; Javascript -Velineste.</div>'+
	'<div class="listing">&bull; Icons and art (and these Log Entries too) -Xodabeef.</div>'+
	...
	'</div><div class="subsection update">'+ //unfinished
	...
	Game.Init=function()
	{
		...
		l('versionNumber').innerHTML='v. '+Game.version+(Game.beta?' <span style="color:#ff0;">Modified Beta (Nwero Clicker v7_11)</span>':'');
		...
		Game.shimmerTypes={
			...
			'golden':{
				...
				popFunc:function(me)
				{
					...
					if (me.wrath>0 && Math.random()<0.3) list.push('blood frenzy','chain cookie','Neuro storm');
					else if (Math.random()<0.03 && Game.cookiesEarned>=100000) list.push('chain cookie','Neuro storm');
		...
		Game.UpdateMenu=function()
		{
			...
			else if (Game.onMenu=='stats')
			{
				...
				'<div class="listing"><b>Neuros baked (this ascension) :</b> <div class="price plain">'+Game.tinyCookie()+Beautify(Game.cookiesEarned)+'</div></div>'+
				'<div class="listing"><b>Neuros baked (all time) :</b> <div class="price plain">'+Game.tinyCookie()+Beautify(Game.cookiesEarned+Game.cookiesReset)+'</div></div>'+
		...
		new Game.Object('Mine','mine|mines|mined|[X] mile deeper|[X] miles deeper','Mines out Neuro dough and chocolate chips.',4,3,{base:'mine',xV:16,yV:16,w:64,rows:2,x:0,y:24},10000,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Chancemaker','chancemaker|chancemakers|spontaneously generated|Chancemakers are powered by [X]-leaf clovers|Chancemakers are powered by [X]-leaf clovers','Generates Neuros out of thin air through sheer luck.',15,19,{base:'chancemaker',xV:8,yV:64,w:64,rows:1,x:0,y:0},77777777777,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		Game.foolObjects={
			...
			'Chancemaker':{name:'Privatized planet',desc:'Actually, you know what\'s cool? A whole planet dedicated to producing, advertising, selling, and consuming your Neuros.',icon:15},
		...
		Game.GrandmaSynergy('Miner grandmas','A nice miner to dig more Neuros.','Mine');
		...
		order=255;
		Game.GrandmaSynergy('Lucky grandmas','A fortunate grandma that always seems to find more Neuros.','Chancemaker');
		
		order=1200;
		new Game.TieredUpgrade('Your lucky cookie','Chancemakers are <b>twice</b> as efficient.<q>This is the first Neuro you\'ve ever baked. It holds a deep sentimental value and, after all this time, an interesting smell.</q>','Chancemaker',1);
